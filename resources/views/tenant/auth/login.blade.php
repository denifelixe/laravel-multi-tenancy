@php
    $views_path = 'views/tenant/auth/login';
@endphp
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __($views_path . '.sign_in_to') . ' ' . strtoupper(subdomain()) }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('login', ['tenant' => subdomain()]) }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link" href="{{ route('password.request', ['tenant' => subdomain()]) }}">
